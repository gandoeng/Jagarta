...
@section('content')
	...
	<main>
		...
		<section class="section-leader-welcome">
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-12  p-white" data-aos="zoom-in" data-aos-once="false" data-aos-mirror="true" data-aos-mirror="true">
						<h1 class="h1-call" >Welcome</h1>
						<h1 class="h1-call">Future</h1>
						<h1 class="h1-call">Leader!</h1>
					</div>
					<div class="col-lg-6 col-md-12  p-white wl-desc" data-aos="zoom-in" data-aos-once="false" data-aos-mirror="true">
							...
							<div class="show-md">
								<div class="dropdown">
								  ...
								  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								    <a class="dropdown-item" href="#">Independent Investment Advisor</a>
								    <a class="dropdown-item" href="#">High Net Worth Individuals</a>
								    <a class="dropdown-item" href="#">Pension Fund</a>
								    <a class="dropdown-item" href="#">Asset Management</a>
								    <a class="dropdown-item" href="#">Local Institution</a>
								    <a class="dropdown-item" href="#">Foreign Institution</a>
								  </div>
								</div>
							</div>
						...
						<div class="col-lg-12">
							<div id="carouselAbout" class="carousel slide" data-ride="carousel">
								...
								<a class="carousel-control-prev" href="#carouselAbout" role="button" data-slide="prev" data-aos="fade" data-aos-once="false" data-aos-mirror="true" data-aos-duration="1500">
									<i class="fas fa-chevron-left coroulus-i"></i>
								...
								<a class="carousel-control-next" href="#carouselAbout" role="button" data-slide="next" data-aos="fade" data-aos-once="false" data-aos-mirror="true" data-aos-duration="1500">
    								<i class="fas fa-chevron-right coroulus-i" ></i>    							
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12 ">
						...
						<!-- Swiper -->
  						<div class="swiper-container swHistory" id="history" data-aos="zoom-in" data-aos-once="false" data-aos-mirror="true" data-aos-duration="1000">
   						...
   						<div class="swiper-container swHistory" data-aos="zoom-in" data-aos-once="false" data-aos-mirror="true" data-aos-duration="1000">
   							<div class="swiper-wrapper">
      							<div class="swiper-slide">
      						...
      						<!-- Add Arrows -->
    					<div class="swiper-button-next" style="color: #AE5528; top: 25%;" role="button" data-slide="prev" data-aos="fade" data-aos-once="false" data-aos-duration="1500"></div>
    					<div class="swiper-button-prev" style="color: #AE5528; top: 25%;" role="button" data-slide="prev" data-aos="fade" data-aos-once="false" data-aos-duration="1500"></div>
							...
							<div class="team_wrapper">
								...
								<div class="team_each d-md-flex">
									...
									<div class="team_details team_content_w flex-grow-1 d-md-flex">
										<div class="team_details_inner align-self-center p-3" data-aos="fade" data-aos-once="false" data-aos-duration="2000" data-aos-mirror="true">
		...
		<!--batik-->
		<section class="section-batik" id="services">
			<div class="container">
				<div class="row">
			...
			<div id="credentials">
				<div class="container ">
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="swiper-container swCredential" id="credential">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<img src="{{asset('img/credential/bmw.png')}}">
									</div>
									<div class="swiper-slide">
										<img src="{{asset('img/credential/clorox.png')}}">
									</div>
									<div class="swiper-slide">
										<img src="{{asset('img/credential/drpepper.png')}}">
									</div>
									<div class="swiper-slide">
										<img src="{{asset('img/credential/gillette.png')}}">
									</div>
									<div class="swiper-slide">
										<img src="{{asset('img/credential/gm.png')}}">
									</div>
								</div>
							</div>

							<div class="swiper-button-prev" style="color: #AE5528;"></div>
							<div class="swiper-button-next" style="color: #AE5528;"></div>
						</div>
						<div class="col-lg-12" data-aos="slide-up" data-aos-duration="2000" data-aos-once="false">
		...
		<section class="section-licence">
			<div class="container">
				<div class="licence-center">
					<div class="row">
					<div class="col-md-12 col-lg-6" data-aos="fade-up" data-aos-duration="2000" data-aos-once="false" data-aos-mirror="true">
						<div class="col-lg-12">
					...
					<div class="col-md-12 col-lg-6 " data-aos="fade-down" data-aos-duration="2000" data-aos-once="false" data-aos-mirror="true">
						<div class="col-lg-12">
